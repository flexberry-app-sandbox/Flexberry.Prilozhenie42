...
namespace IIS.Prilozhenie_42
{
    ...
    public class КартДоступ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_42.СправСотр fСправСотр;
        
        private IIS.Prilozhenie_42.DetailArrayOfБазаДанных fБазаДанных;
        ...
        [PropertyStorage(new string[] {
                "СправСотр"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_42.СправСотр СправСотр
        {
            get
            {
                ...
                IIS.Prilozhenie_42.СправСотр result = this.fСправСотр;
        ...
        public virtual IIS.Prilozhenie_42.DetailArrayOfБазаДанных БазаДанных
        {
            get
            {
                ...
                {
                    this.fБазаДанных = new IIS.Prilozhenie_42.DetailArrayOfБазаДанных(this);
                }
                IIS.Prilozhenie_42.DetailArrayOfБазаДанных result = this.fБазаДанных;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартДоступE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартДоступE", typeof(IIS.Prilozhenie_42.КартДоступ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартДоступL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартДоступL", typeof(IIS.Prilozhenie_42.КартДоступ));
                }
            }
        }
    }
