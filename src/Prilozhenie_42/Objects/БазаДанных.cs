...
namespace IIS.Prilozhenie_42
{
    ...
    public class БазаДанных : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_42.СправУч fСправУч;
        
        private IIS.Prilozhenie_42.КартДоступ fКартДоступ;
        ...
        [PropertyStorage(new string[] {
                "СправУч"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_42.СправУч СправУч
        {
            get
            {
                ...
                IIS.Prilozhenie_42.СправУч result = this.fСправУч;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_42.КартДоступ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "КартДоступ"})]
        public virtual IIS.Prilozhenie_42.КартДоступ КартДоступ
        {
            get
            {
                ...
                IIS.Prilozhenie_42.КартДоступ result = this.fКартДоступ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БазаДанныхE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БазаДанныхE", typeof(IIS.Prilozhenie_42.БазаДанных));
                }
            }
        }
    }
    ...
    public class DetailArrayOfБазаДанных : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_42.DetailArrayOfБазаДанных members)

        // *** End programmer edit section *** (IIS.Prilozhenie_42.DetailArrayOfБазаДанных members)
        ...
        /// </summary>
        public DetailArrayOfБазаДанных(IIS.Prilozhenie_42.КартДоступ fКартДоступ) : 
                base(typeof(БазаДанных), ((ICSSoft.STORMNET.DataObject)(fКартДоступ)))
        {
        }
        
        public IIS.Prilozhenie_42.БазаДанных this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_42.БазаДанных)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_42.БазаДанных dataobject)
        {
